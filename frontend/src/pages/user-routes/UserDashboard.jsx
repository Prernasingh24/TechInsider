...
import { deletePost, deletePostService, loadPostUserWise } from "../../services/post-service";
...
const UserDashboard = ()=>{
    ...
    deletePostService(post.postId).then(res=>{
        ...
        let newPosts=posts.filter(p=>p.postId!=post.postId) //now we dont have to refresh the page
        setPosts({...newPosts})
    }).catch(error=>{
        console.log(error)
